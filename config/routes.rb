DdeServer::Application.routes.draw do
  ...
  resources :people do
    ...
    collection do
      post :sync_demographics_with_master, :sync_demographics_with_proxy, :people_to_sync, :demographics_to_sync, :getPeopleIdsCount
      get :find, :sync_demographics_with_master, :sync_demographics_with_proxy, :people_to_sync, :demographics_to_sync, :getPeopleIdsCount
    end
  end
